...
// MARK: Dependency Injection Made Composable - Environment in the reducer
...
// MARK: Dependency Injection Made Composable - Environment in the store
// MARK: Library
...
public final class Store<Value, Action>: ObservableObject {
    ...
    // MARK: Dependency Injection Made Composable - Erasing the environment from the store
